...
import type { TransRenderProps } from './trans-no-context'

export interface NextLinguiContext {
  i18n: I18n
  _: I18n['_']
  defaultComponent?: ComponentType<TransRenderProps>
}

export type I18nProviderProps = Omit<NextLinguiContext, '_'> & {
  children?: React.ReactNode
}

export const LinguiContext = React.createContext<NextLinguiContext | null>(null)

export const useLinguiInternal = (
  ...
  return context as NextLinguiContext
}
export function useLingui(): NextLinguiContext {
  return useLinguiInternal()
}

export function NextLinguiProvider({
  i18n,
  defaultComponent,
  children,
}: I18nProviderProps) {
  ...
  const [context, setContext] = React.useState<NextLinguiContext>(makeContext())
