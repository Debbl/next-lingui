 ...
 */
import type { NextLinguiContext } from './next-lingui-provider'

export { TransNoContext } from './trans-no-context'
export type {
  TransProps,
  TransRenderCallbackOrComponent,
  TransRenderProps,
} from './trans-no-context'

interface CtxValueRef {
  current: NextLinguiContext | null
}
...
export function setI18n(
  i18n: I18n,
  defaultComponent?: NextLinguiContext['defaultComponent'],
) {
 ...
 * ```
 */
export function getI18n(): NextLinguiContext | null {
