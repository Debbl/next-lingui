...
const runOnce = once('_NEXT_LINGUI_COMPILE_MESSAGES');
...
export default function createMessagesDeclaration(
  ...
  // https://github.com/amannn/next-lingui/issues/2006
  const shouldBailOut = [
    'info',
    'start'
...
function compileDeclaration(
  ...
  function createDeclaration(content: string) {
    return `// This file is auto-generated by next-lingui, do not edit directly.
// See: https://next-lingui.dev/docs/workflows/typescript#messages-arguments
