...
function getFormatterCachedImpl(config: LinguiConfig) {
  ...
  return {
    ...
    dateTimeRange: (startDate: Date | number, endDate: Date | number, options?: Intl.DateTimeFormatOptions) => new Intl.DateTimeFormat(locale, options).formatRange(startDate, endDate),
    list: (list: Array<string>, options?: Intl.ListFormatOptions) => new Intl.ListFormat(locale, options).format(list)
  };
}
