...
import type { Pathnames } from '../routing'
  ...
  describe('localePrefix: as-needed', () => {
    ...
    describe('localized pathnames', () => {
      ...
      it('serves requests for non-ascii characters that are encoded', () => {
        ...
        middlewareWithPathnames(
          createMockRequest(`/ja/${encodeURIComponent('ユーザー')}/1`, 'ja'),
        )
        middlewareWithPathnames(
          createMockRequest(
            `/ja/${encodeURIComponent('ニュース')}/happy-newyear-g5b116754`,
            'ja',
          ),
        )
        middlewareWithPathnames(
          createMockRequest(
            `/ja/${encodeURIComponent('製品')}/${encodeURIComponent(
              'アパレル',
        ...
        middlewareWithPathnames(
          createMockRequest(
            `/ja/${encodeURIComponent('カテゴリー')}/${encodeURIComponent(
              '女性',
            )}/${encodeURIComponent('ティーシャツ')}`,
            'ja',
          ),
